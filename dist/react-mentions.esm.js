  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSuggestionsOverlay", function () {
      ...
      var _this$props3 = _this.props,
          showSuggestions = _this$props3.showSuggestions,
          suggestionsHandler = _this$props3.suggestionsHandler;

      if (!showSuggestions) {
        var suggestions = Object.values(_this.state.suggestions).reduce(function (accResults, _ref) {
          var results = _ref.results,
              queryInfo = _ref.queryInfo;
          return [].concat(_toConsumableArray(accResults), _toConsumableArray(results.map(function (result, index) {
            return {
...
_defineProperty(MentionsInput, "defaultProps", {
  ...
  suggestionsHandler: function suggestionsHandler() {
    return null;
  }
});
